...
from early_vision.utils.model_utils import genFilterBank
...
class ReducedV1NetCell(nn.Module):
    def __init__(self,
        ...
        self.padding_exc = (self.kernel_size_exc -
                            1) // 2, (self.kernel_size_exc - 1) // 2
        self.padding_inh = (self.kernel_size_inh -
                            1) // 2, (self.kernel_size_inh - 1) // 2
        self.device = device
